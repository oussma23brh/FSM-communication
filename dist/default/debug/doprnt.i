...
static void stoa(FILE *fp, char *s)
{
 ...
 if (!(prec < 0) && (prec < l)) {
  l = prec;
    ...
    p = l;
# 979 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    while (p--) {
        fputc(*cp, fp);
        ++cp;
    }
# 997 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
}
# 1055 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
...

{
 ...
 int p;
# 1076 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    if (!(prec < 0)) {
        flags &= ~(1 << 1);
    }
    ...
    w = width;
# 1095 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 2) && (d != 0
...
# 1152 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    return (void) pad(fp, &dbuf[i], w);
}
...
# 1265 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
        if ((*fmt)[0] == '.') {
            ++*fmt;
...
# 1495 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
   ...
   *fmt = cp+1;
   switch (*cp) {
# 1547 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    case 'X':
